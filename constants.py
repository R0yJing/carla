...
EPISODIC_DURATION = 300
##########
NUM_SAMPLES_PER_COMMAND_PER_ITER = 3000#7130
NUM_SAMPLES_PER_ITER = NUM_SAMPLES_PER_COMMAND_PER_ITER * 3
MAX_REPLAY_BUFFER_SIZE = NUM_SAMPLES_PER_ITER * 10 # 95200 * 4#161289

#############debug##############
DEBUG_NUM_SAMPLES_PER_COMMAND_PER_ITER = 3000
DEBUG_NUM_SAMPLES_PER_ITER = DEBUG_NUM_SAMPLES_PER_COMMAND_PER_ITER * 3
DEBUG_MAX_REPLAY_BUFFER_SIZE = DEBUG_NUM_SAMPLES_PER_ITER * 10
####################
TOTAL_NUM_ITER = 10
BENCHMARK_LIMIT = 100
LANE_INV_TIMEOUT = 1
DEBUG_BENCHMARK_LIMIT = 3
SAMPLE_TIME=0.1
TARGET_TOLERANCE = 3
