...
class CarEnv:
    def __init__(self, training=True, port=2000):
        ...
        self.cl.set_timeout(5000)
        self.training = training
        self.w = self.cl.get_world()
        self.throttle = 0
        settings  =self.w.get_settings()
        settings.fixed_delta_seconds = 0.05
        self.w.apply_settings(settings)
    ...
    def reset(self):
        ...
        self.w.debug.draw_string(self.target_loc, "target", life_time=10)
    ...
    def update_target(self):
        ...
        print("current direction" + ["follow", "left", "right"][self.current_direction - 2])
        self.waypoint_timer = time.time()
